...
data_sets = {
    ...
    'Commodities': [
        # ('2025-03-24', 'BalticDry', 1652.0),
        # ('2024-03-05', 'Natural gas', 2.095),
        # ('2024-05-09', 'Silver', 28.132),
        # ('2026-01-15', 'Lumber', 558.1),
    ],
    'Economics': [
        # ('2024-10-15', 'ImportPriceY', -0.1),
        # ('2025-05-10', 'CoreCPI', 2.8),
        ...
        # ('2024-12-08', 'USNonPMI', 52.1),
        # ('2025-06-06', 'USUnemploy', 4.2),
    ],
    'ETFs': [
        # ('2024-10-29', 'SCHX', 22.97, 4190157),
        # ('2024-07-11', 'CoreCPI', 3.3)
        # ('2025-10-01', 'GOEX', 8, 236635)
    ],
    'Basic_Materials': [
