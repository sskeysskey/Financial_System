...
# 更新价格字段
# cursor.execute("UPDATE MNSPP SET marketcap = 7307000000.0 WHERE id = 1480")
# cursor.execute("UPDATE MNSPP SET marketcap = 7538300000.0, pe_ratio = 28.78 WHERE symbol = 'SOLS'")
# cursor.execute("DELETE FROM MNSPP WHERE symbol = 'BRK-A'")
# cursor.execute("UPDATE MNSPP SET pb = 34.43 WHERE id = 1219")
# cursor.execute("UPDATE Earning SET price = -24.6 WHERE id = 1624")
# cursor.execute("UPDATE Earning SET name = 'BRK-B' WHERE name = 'BRK-B'")
...
# cursor.execute("UPDATE ETFs SET volume = 41333 WHERE id = 2472174")
...
# cursor.execute("UPDATE Industrials SET volume = 3202310 WHERE id = 1147379")
