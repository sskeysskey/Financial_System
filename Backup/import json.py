...
# 读取b.json文件
with open('/Users/yanzhang/Documents/Financial_System/Modules/Sectors_All.json', 'r', encoding='utf-8') as f:
    data_b = json.load(f)
...
# 保存修改后的b.json文件
with open('/Users/yanzhang/Documents/Financial_System/Modules/Sectors_All.json', 'w', encoding='utf-8') as f:
