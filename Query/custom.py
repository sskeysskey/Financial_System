...
if __name__ == '__main__':
    ...
    db_info = [
        ...
        #   'condition': "name = 'United States'", 'fields': '*'},
        # {'path': '/Users/yanzhang/Documents/Database/Finance.db', 'table': 'Basic_Materials',
        #     'condition': "name = 'LIN' ORDER BY date DESC", 'fields': '*'},
        ...
        #     'condition': "name = 'AMZN' ORDER BY date DESC", 'fields': '*'},
